...
class calculator:
    ...
    def Main_Calculator(self):
        ...
        self.Square_Root_Button = Button(frame, text="\u00B2\u221A", font="Verdana 12 bold", width=5)
        self.Square_Root_Button.grid(row=1, column=0)

        self.Root_Button = Button(frame, text="\u02E3\u221A", font="Verdana 12 bold", width=5)
        self.Root_Button.grid(row=1, column=1)

        self.Square_Button =Button(frame, text="x\u00B2", font = "Verdana 12 bold", width=5)
        self.Square_Button.grid(row=1, column=2)

        self.Exponent_Button = Button(frame, text="x\u02E3", font= "Verdana 12 bold", width=5)
        self.Exponent_Button.grid(row=1, column=3)
